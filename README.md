...
2. Applications must be compiled with GCC if you want proper behaviour. (MSVC works, but you can't make non-inline functions. GCC works! ...except you can't make inline functions, the opposite problem.)
